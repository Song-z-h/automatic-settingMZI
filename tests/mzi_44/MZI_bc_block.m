function [U_mzi, VC] = MZI_bc_block(out_a, phi_target, theta_target, imperfections)
   ...
   %0.5000 - 0.5010i];
    ...
    desired_phi = phi_target;
    desired_theta = theta_target;
    ...
    [theta, delta_c] = MZI_C(outb,PR_C, theta, imperfections, dpr_target_c);
     it=it+1;
     end
